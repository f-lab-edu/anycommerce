...
-- Terms 테이블 초기 데이터
INSERT INTO terms (title, content, is_required, version, is_active, created_at, updated_at)
VALUES
    ('이용약관 동의', '서비스 이용에 대한 약관입니다.', 1, '1.0', 1, NOW(), NOW()),
    ('개인정보 수집 이용 동의(필수)', '개인정보 보호에 대한 정책입니다.', 1, '1.0', 1, NOW(), NOW()),
    ('개인정보 수집 이용 동의(선택)', '개인정보 보호에 대한 정책입니다.', 0, '1.0', 1, NOW(), NOW()),
    ('마케팅 정보 활용 동의', '마케팅 정보를 활용하는 약관입니다.', 0, '1.0', 0, NOW(), NOW()), -- 비활성화된 약관
    ('만 14세 이상', '본인은 만 14세 이상입니다.', 1, '1.0', true, NOW(), NOW()),
    ('개인정보 수집 이용 동의(필수)', '개인정보 보호에 대한 정책입니다. (필수사항입니다.)', 1, '1.1', 1, NOW(), NOW()),
    ('개인정보 수집 이용 동의(선택)', '개인정보 보호에 대한 정책입니다. (선택사항입니다.)', 0, '1.1', 1, NOW(), NOW()),
--    ('마케팅 정보 활용 동의', '마케팅 정보를 활용하는 약관입니다. 이메일 또는 문자로 발송됩니다.', 0, '1.1', NOW(), NOW()),
    ('개인정보보호법 관련 신규 약관', '새로운 약관입니다.', 1, '1.0', 1, NOW(), NOW());
